...
module Ethon
  module Curls
    # This module contains logic for the available informations on easy.
    module Infos
      # Return info types.
      #
      ...
      # https://github.com/bagder/curl/blob/master/include/curl/curl.h#L450
      #
      ...
      # https://github.com/bagder/curl/blob/master/src/tool_writeout.c#L74 for details
      #
